...
/// Preview a company invite before the parent redeems it.
                ...
                VStack(alignment: .leading, spacing: 16) {
                    ...
                    if loading {
                        ...
                        VStack(alignment: .leading, spacing: 8) {
                            Text(preview.title)
                                ...
                                .foregroundStyle(.white)
                            Text("Role: \(preview.membershipType)")
                    ...
                    Button(action: join) {
                        Text(submitting ? "Joining…" : "Join company")
                            ...
                            .padding(.vertical, 14)
                            .background(
                                LinearGradient(colors: [accent, Color(hex: "#6366F1")], startPoint: .leading, endPoint: .trailing),
