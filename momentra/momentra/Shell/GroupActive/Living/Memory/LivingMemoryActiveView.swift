...
/// Shared Living Memory (G09–G12). Live APIs only.
struct LivingMemoryActiveView: View {
        ...
        NativeDashboardScaffold(background: theme.bg) {
            ...
            VStack(alignment: .leading, spacing: 14) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    Text(people > 0 ? "\(people) people shaped this household" : "People appear when residents are live")
                ...
                LivingSectionCard(theme: theme, title: "Memory Timeline") {
                    if items.isEmpty {
                        LivingEmptyBlock(
                            theme: theme,
                ...
                LivingSectionCard(theme: theme, title: "Memory Gallery") {
                ...
                LivingSectionCard(theme: theme, title: "People Impact") {
                    GroupMetricTile(label: "Residents", value: people > 0 ? "\(people)" : "—")
                ...
                LivingSectionCard(theme: theme, title: theme.budgetTitle) {
                    HStack(spacing: 8) {
                        GroupMetricTile(
                            label: "Budget",
                ...
                LivingSectionCard(theme: theme, title: "Memory Intelligence") {
                    LivingEmptyBlock(
                        theme: theme,
