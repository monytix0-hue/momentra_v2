...
enum GroupSetupCatalog {
    static let experienceTypes: [GroupTypeOption] = [
        ...
        .init(code: "HOUSE_PARTY", label: "Celebration/House Party", emoji: "🎉", nameLabel: "Party Name", defaultName: "Rooftop House Party", defaultDates: "22 Nov 2025", defaultNotes: "Music, food, and easy RSVPs.", iconName: "ges_type_party"),
    ...
    static let purchase = GroupSetupVariant(
        ...
        budgetNote: "Saved on this device — syncs when budget API ships",
        types: [
