...
const ENDPOINTS: EndpointDef[] = [
  ...
  { method: 'get', path: '/me/notification-preferences', operationId: 'getMyNotificationPreferences', summary: 'Get global push notification preferences', tags: ['Notifications'], kind: 'read', implStatus: 'IMPLEMENTED' },
  { method: 'patch', path: '/me/notification-preferences', operationId: 'patchMyNotificationPreferences', summary: 'Update global push notification preferences', tags: ['Notifications'], kind: 'command', implStatus: 'IMPLEMENTED' },
  { method: 'get', path: '/moments/{momentId}/notification-preferences', operationId: 'getMomentNotificationPreferences', summary: 'Get moment push notification preferences', tags: ['Notifications'], kind: 'read', implStatus: 'IMPLEMENTED' },
  { method: 'patch', path: '/moments/{momentId}/notification-preferences', operationId: 'patchMomentNotificationPreferences', summary: 'Update moment push notification preferences', tags: ['Notifications'], kind: 'command', implStatus: 'IMPLEMENTED' },
