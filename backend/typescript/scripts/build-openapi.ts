...
const ENDPOINTS: EndpointDef[] = [
  ...
  { method: 'get', path: '/polls/{pollId}', operationId: 'getPoll', summary: 'Get poll', tags: ['Poll'], kind: 'read', implStatus: 'CONTRACT_ONLY' },
  { method: 'post', path: '/polls/{pollId}/votes', operationId: 'votePoll', summary: 'Cast poll vote', tags: ['Poll'], kind: 'command', idempotency: true, implStatus: 'CONTRACT_ONLY' },
  { method: 'post', path: '/polls/{pollId}/close', operationId: 'closePoll', summary: 'Close poll', tags: ['Poll'], kind: 'command', idempotency: true, occ: true, implStatus: 'CONTRACT_ONLY' },
